  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div className="p-4 rounded-lg bg-slate-900 border border-gray-300 shadow-lg">
              ...
              <p className="text-white text-sm">
                We understand that challenges can arise. Our dedicated support
                team is ready to help with quick, effective solutions.
              </p>
            ...
            <div className="p-4 rounded-lg bg-white border border-gray-300 shadow-lg">
              <h3 className="text-xl font-bold mb-3 flex flex-col items-center">
                <FontAwesomeIcon
                  icon={faPaperPlane}
                  className="text-slate-900 text-3xl mb-1"
                />
                Feedback & Suggestions
              </h3>
              <p className="text-sm text-gray-800">
                Your feedback helps us grow. We’re constantly improving and
                value your insights to serve you better.
              </p>
            ...
            <div className="p-4 rounded-lg bg-white border border-gray-300 shadow-lg">
              ...
              <p className="text-sm text-gray-800 mb-4">
                Our team is available around the clock to support your shipping
      ...
      <section id="features" className="bg-gray-200 py-12 w-full mt-1">
        <div className="w-full mx-auto px-2 sm:px-4 md:px-4 lg:px-6 text-left">
          <h2 className="text-2xl md:text-3xl font-bold mx-2 md:mx-0 mb-5 text-black">
            We're Here 24/7 – Get in Touch
          </h2>
          <p className="text-lg md:text-xl mx-2 md:mx-0 mb-9">
            We'd love to hear from you! Please fill out the contact form, and
            our <br /> team will get back to you as soon as possible.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 items-stretch w-full mx-auto">
            {/* Image Section */}
            <div className="flex justify-center items-stretch px-1 sm:px-0">
              <img
                src={customer2}
                alt="customer"
            ...
            <div className="flex justify-center items-stretch px-1 sm:px-0">
              <div className="p-4 sm:p-6 rounded-lg bg-white shadow-lg w-full mx-auto h-full">
